...
const useApproveCountReviewDataTable = (tasks: TCountReviewTaskDataType[]) => {
  ...
  const countReviewTaskColumns = useCreateCountReviewTasksColumns({
    dataTestId: 'approve-counting-review',
  ...
  return {
    ...
    dataTableProps: validateDataTableProps<TCountReviewTaskDataType>({
      type: 'data',
      tableId: DataTableIds.ApproveCountReviewTasks,
...
export default useApproveCountReviewDataTable;
