...
const useInboundDeliveryTasksDataTable = (
  deliveryId: string,
  ...
  const createTaskColumns = useCreateTaskColumns({ dataTestId: 'delivery-tasks' });
  ...
  return {
    ...
    triggerIbdTaskDataTableRefetch: triggerDataTableRefetch,
    ibdTaskDataTableProps: validateDataTableProps<
      TTasksDataType,
      TTasksFilterType,
      TTasksFieldNames
    >({
      type: 'query',
      tableId: DataTableIds.InboundDeliveryTasks,
      tableHeader: t('deliveries.deliveryTasks'),
...
export default useInboundDeliveryTasksDataTable;
