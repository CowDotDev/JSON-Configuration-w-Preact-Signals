...
const useCreatePutawayLicensePlateColumns = ({
  addColumnsToStart,
  dataTestId,
  removeColumns = [],
}: {
  ...
  const createPutawayLicensePlate = useCallback<TColumnFactory<TBaseInvStockDataType>>(
    (columnHelper) => {
      const columns = [
  ...
  return createPutawayLicensePlate;
};

export default useCreatePutawayLicensePlateColumns;
